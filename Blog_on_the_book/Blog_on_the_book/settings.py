"""
Django settings for Blog_on_the_book project.
...
SECRET_KEY = '33s#z$p@*w2z+r%jv=8^$+!skq-0x$#vt@o78drn5k2b$@%vdy'
...
ROOT_URLCONF = 'Blog_on_the_book.urls'
...
WSGI_APPLICATION = 'Blog_on_the_book.wsgi.application'
